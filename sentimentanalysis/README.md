Here’s a polished, professional README that captures everything you’ve described and presents it in a clean, developer‑friendly format:
...
- Prediction Result: Displays whether the sentiment is Positive or Negative.
   ![Prediction page](docs/image.png)
